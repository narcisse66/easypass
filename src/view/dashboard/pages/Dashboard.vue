        ...
        <div class="row">
          <div class="col-md-12">
            <div class="d-main-title">
              <h3><i class="fa-solid fa-gauge me-3"></i>Tableau de board</h3>
            </div>
          </div>
          <div class="col-md-12">
            <div class="main-card add-organisation-card p-4 mt-5">
              ...
              <div class="ocard-right">
                ...
                >
                  <i class="fa-solid fa-plus"></i>Add Organisateur
                </button>
              </div>
            </div>
            <div class="main-card mt-4">
              <div class="dashboard-wrap-content">
                <div
                  class="d-flex flex-wrap justify-content-between align-items-center p-4"
                >
                  <div
                  ...
                  <div class="row">
                    <div class="col-xl-3 col-lg-6 col-md-6">
                      <div class="dashboard-report-card purple">
                        <div class="card-content">
                          <div class="card-content">
                            <span class="card-title fs-6">Revenue (Fcfa)</span>
                            <span class="card-sub-title fs-3">100000fcfa</span>
                      ...
                      <div class="dashboard-report-card red">
                        <div class="card-content">
                          <div class="card-content">
                            ...
                            <span class="card-sub-title fs-3">9</span>
                            <div class="d-flex align-items-center"></div>
                          </div>
                          <div class="card-media">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6">
                      <div class="dashboard-report-card info">
                        <div class="card-content">
                          <div class="card-content">
                            <span class="card-title fs-6">Vues</span>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6">
                      <div class="dashboard-report-card success">
                        <div class="card-content">
                          <div class="card-content">
                            <span class="card-title fs-6">Tickets vendues</span>
              ...
              >
                ...
                >
                  <div class="select-graphic-category">
                    ...
                    <small class="mt-4"
                      >See the graphical representation below</small
                    >
                  </div>
                </div>
                <div class="rs">
